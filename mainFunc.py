...
if(__name__ == "__main__"):
    ...
    for freq_i in range(5, 6):
        for life_i in range(5, 6):
            for amount_i in range(20, 21):
                for rate_i in range(5, 6):
                    for neighbor_i in range(1, 25):
                        for folderNum_i in range(11, 12):
                            x += 1
    ...
    #crossValidationFunc(featureFolder, labelFolder, bagging_classifierComparison)
                            ...
                            if(new_accuracy >= old_accuracy):
                                para.append([freq_i, life_i, amount_i, rate_i, neighbor_i, folderNum_i, new_accuracy])
